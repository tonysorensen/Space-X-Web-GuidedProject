...
function getWindowFromNode(node) {
  if (node.defaultView) {
    ...
    throw new Error("It looks like you passed a Promise object instead of a DOM node. Did you do something like `fireEvent.click(screen.findBy...` when you meant to do `fireEvent.click(await screen.getBy...`?");
  } else {
